 ...
 * [lint](https://github.com/golang/lint) *required*
   * If an autogenerated file or self-descript file should really not be linted, the following line of code at the top of the file will prevent lintenization:
````
// Code generated this comment suppresses golint; DO NOT EDIT. 
````
